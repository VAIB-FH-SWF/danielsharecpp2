========================================================================
    KONSOLENANWENDUNG: Bildverarbeitung3-Projektübersicht
========================================================================

Diese Bildverarbeitung3-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Bildverarbeitung3-Anwendung besteht.


Bildverarbeitung3.vcxproj
...
Bildverarbeitung3.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Bildverarbeitung3.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
